...
## Aimed Shots (Melee) (p. 170)

At a maximum of **1 ROF**, you can aim a single Melee Attack by taking your entire Action and a **-8 to your Check**.
...
| **Leg** | If a single point of damage gets through body armor, target suffers the **Broken Leg** Critical Injury (if they have unbroken legs) |
...
Both you and your target (within reach) roll:
...
- Both participants are in a **Grapple** and take **-2 to all Actions** for the duration.
- The **Defender cannot use their Move Action** and is **dragged with the Attacker** whenever the Attacker moves.
...
- Use the **Grenade Launcher DV** entry on the range table.
...
**vs.**
**Defender's DEX + Evasion + 1d10** (or a **DV** for some Special Moves)
...
## Melee-Relevant Cyberware

The following cyberware directly affects melee combat (see *cyberware.md* for full details):

- **Cyberarm** (Cyberlimb): Brawling damage is always at least **2d6**. Has 4 Option Slots. (p. 116)
- **Rippers** (Cyberarm Option): Implanted claws. Melee Weapon, **2d6** damage, **2 ROF**, concealable. (p. 116)
- **Wolvers** (Cyberarm Option): Implanted blades. Melee Weapon, **3d6** damage, **2 ROF**, concealable. (p. 116)
- **Big Knucks** (Cyberarm Option): Reinforced knuckles. Brawling damage +**1d6**. (p. 116)
- **Scratchers** (Cyberarm Option): Razor-sharp fingernails. Melee Weapon, **1d6** damage, **2 ROF**, concealable. (p. 116)
- **Grapple Hand** (Cyberarm Option): Allows grappling at range up to 30 m/yds. (p. 116)
- **Cyberleg** (Cyberlimb): Has 3 Option Slots. Jump boosters and other enhancements available. (p. 117)
- **Skinweave** (External Cyberware): Subdermal armor, provides **SP 7** to body and head without armor penalty. Stacks with no other armor. (p. 115)

---

## Melee and Vehicles (p. 191-192)

- Against a **stationary vehicle**, there's no reason not to aim for a weak point with a Melee Attack because vehicles can't dodge and **you automatically hit**. (p. 192)
- Against a **moving vehicle**, you must beat **DV13** to hit the weak point and the **-8 Aimed Shot penalty** still applies. (p. 192)
